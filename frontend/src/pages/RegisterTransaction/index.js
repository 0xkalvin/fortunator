...
export default function RegisterTransaction() {
  ...
  function HandleCategoryCreated(props) {
    useEffect(() => {
      try {
        api
          .get(
            "/transactions/categories/created/" + localStorage.getItem("userId")
          )
          .then((response) => {
  ...
  return (
    <div>
              ...
              return (
                ...
                >
                  {categoryOptionsCreated.map((categoryOptionsCreated) => (
                    <option
                      key={categoryOptionsCreated.id}
                      value={categoryOptionsCreated.id}
                    >
                      {categoryOptionsCreated.description}
                    </option>
                  ))}
                </select>
              );
      ...
      <div className="div-trasaction">
        <div className="div-input-transacao-esquerda">
          <label htmlFor="DateTransaction">
            <h2 className="h2-label">Valor</h2>
          </label>
          <input
            type="text"
            className="input-maior"
      ...
      <div className="div-trasaction">
        <div className="div-input-transacao-esquerda">
          <label htmlFor="CategoryTransaction">
            <h2 className="h2-label">Categoria</h2>
          </label>
          {(function () {
          ...
          >
            <BsPlusSquare size={22} color="#00A0A0" />
          </Link>
          <a
            href="#abrirModal"
            className="tooltip"
          ...
          >
            <FiTrash2 size={22} color="#00A0A0" />
          </a>
        </div>
        <div className="div-input-transacao-direita">
          <label htmlFor="TypeTransaction">
            <h2 className="h2-label">Tipo</h2>
          </label>
          <select
